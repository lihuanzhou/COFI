# -*- coding: utf-8 -*-
"""02.WRI COFI_Cleaning_CLA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vOSjBdInvvpQZSnjx-5RQn-H-B21r8LM
...
if len(map_temp) > 1:
    appended_data = []
    print("FILES SEEN BY CLEANING CLA")
...
for i in df.index:
    ...
    # Create a new column mapping to "installed capacity" based on Project Name column
