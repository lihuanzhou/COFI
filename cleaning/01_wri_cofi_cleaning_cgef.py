# -*- coding: utf-8 -*-
"""01.WRI COFI_Cleaning_CGEF.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vQP-AWv0wKh7s61aCkhkP94RmA11HBha
...
if len(map_temp) > 1:
    appended_data = []
    print("FILES SEEN BY CLEANING CGEF")
...
"""2. filter by energy-subsector"""

# Filter by Power Generation and Multipurpose
df = df[df['Energy Sub-sector'].str.contains('Power Generation|Multipurpose')]
df = df.reset_index(drop = True)
...
for i in df.index:
    ...
    df.loc[i,'primary_fuel'] = extract_fuel(df.loc[i,'Energy Source'])
