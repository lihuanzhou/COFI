# -*- coding: utf-8 -*-
"""08.WRI COFI_Cleaning_GPPD.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1v1QmgXfIoVYQTDt-P6X0318jWZOpjbs2
...
if len(map_temp) > 1:
    appended_data = []
    print("FILES SEEN BY CLEANING gppd")
...
#### Filter
1. *NA to this data - filter by year, after 2000
"""
...
# Load the origianl column name that needs to be mapped
fuel_var = df_var[df_var['Column_name'] == 'primary_fuel'].iloc[0,1]
capacity_var = df_var[df_var['Column_name'] == 'installed_capacity'].iloc[0,1]


# try mapping the original fuel tyupe column into a new column
# Only for GPPD
df['primary_fuel_original'] = df[fuel_var]

# add MW unit to capacity
df['installed_capacity'] = df[capacity_var].astype(str) + " MW"

for i in df.index:
    # Map primary fuel types
    df.loc[i,'primary_fuel'] = extract_fuel(df.loc[i,fuel_var])
